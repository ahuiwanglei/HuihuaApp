...
import online.huihua.suzhou.com.huihuaapp.model.ExtContDetailResultData;
...
public class ExtContReviewActivity extends BaseReviewActivity {
    ...
    public void getData() {
        ...
        try {
            ...
            Wethod.jsonPost(Request.Method.POST, this, GET_Data_Tag, HuihuaConfig.Http.ExtContDetail, jsonObject.toString(), this);
    ...
    public void onSuccess(int reqcode, Object result) {
        if (reqcode == GET_Data_Tag) {
            ExtContDetailResultData contDetailResultData = ObjectMapperFactory.convertJsonToObject(result.toString(), ExtContDetailResultData.class);
            ...
            ExtContDetailResultData.ActionResultsListBean bean = contDetailResultData.getActionResultsList().get(0);
            ...
            itemList.add(new ItemDataInfo("展期合同号", bean.getEXT_CONT_NO(), bean.getEXT_CONT_NO()));
...
//            itemList.add(new ItemDataInfo("审核意见", bean.getCHECK_MEMO(), bean.getCHECK_MEMO()));
    ...
    public void postHttpReview() {
        ...
        try {
            ...
            LogUtil.print(jsonObject.toString());
            Wethod.jsonPost(Request.Method.POST, this, Post_Review_Tag, HuihuaConfig.Http.ExtContCheck, jsonObject.toString(), this);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
