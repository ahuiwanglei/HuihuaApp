...
public class PrePayReviewActivity extends BaseReviewActivity {
    ...
    public void getData() {
        ...
        try {
            ...
            Wethod.jsonPost(Request.Method.POST, this, GET_Data_Tag, HuihuaConfig.Http.PrePayDetail, jsonObject.toString(), this);
...
//            实收补偿金 REALPREPAY_CPS"
    ...
    public void postHttpReview() {
        ...
        try {
            ...
            LogUtil.print(jsonObject.toString());
            Wethod.jsonPost(Request.Method.POST, this, Post_Review_Tag, HuihuaConfig.Http.PrePayCheck, jsonObject.toString(), this);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    ...
    public void postHttpVeto() {
        ...
        try {
            ...
            jsonObject.put("Check_opinion", getCheckOpinion());
            LogUtil.print(jsonObject.toString());
            Wethod.jsonPost(Request.Method.POST, this, Post_Review_Tag, HuihuaConfig.Http.PrePayVeto, jsonObject.toString(), this);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
