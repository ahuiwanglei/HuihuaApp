...
public class ContListActivity extends BaseRefreshActivity<ContResultData.ActionResultsListBean> {
    ...
    public void getData() {
        ...
        try {
            ...
            Wethod.jsonPost(Request.Method.POST, this, GET_Data_Tag, HuihuaConfig.Http.ContSelect, jsonObject.toString(), this);
    ...
    public int getItemLayoutId() {
        return R.layout.activity_cont_list_item;
    }
    ...
    public void onListViewItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        intent.setClass(this, ContReviewActivity.class);
