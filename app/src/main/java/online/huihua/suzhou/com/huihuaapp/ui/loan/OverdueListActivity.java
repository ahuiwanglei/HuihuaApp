...
public class OverdueListActivity extends BaseRefreshActivity<LoadApplyResultData.ActionResultsListBean> {
    ...
    public void getData() {
        ...
        try {
            ...
            Wethod.jsonPost(Request.Method.POST, this, GET_Data_Tag, HuihuaConfig.Http.OverdueSelect, jsonObject.toString(), this);
    ...
    public void onListViewItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        intent.setClass(this, OverdueReviewActivity.class);
