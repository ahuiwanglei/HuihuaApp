...
public class ToastUtils {
     ...
     * <p>调用{@link Toast#setView(View)}传入自定义的布局。</p>
     *
     * @param context    上下文
     * @param layoutId   布局Id
    ...
    public static Toast showError(Context context, String msg) {
        return show(context, R.mipmap.img_dialog_error, msg);
    }
    ...
    public static Toast showSuccess(Context context, String msg) {
        return show(context, R.mipmap.img_dialog_sure, msg);
    }
    ...
    public static Toast showSuccess(Context context, int msgId) {
        return show(context, R.mipmap.img_dialog_sure, context.getString(msgId));
    }
    ...
    public static Toast showWarn(Context context, String msg) {
        return show(context, R.mipmap.img_dialog_warning, msg);
    }
    ...
    public static Toast showWarn(Context context, int msgId) {
        return show(context, R.mipmap.img_dialog_warning, context.getString(msgId));
    }
    ...
    public static Toast showInfo(Context context, String msg) {
        return show(context, R.mipmap.img_dialog_info, msg);
    }
    ...
    public static Toast showInfo(Context context, int msgId) {
        return show(context, R.mipmap.img_dialog_info, context.getString(msgId));
    }
}
