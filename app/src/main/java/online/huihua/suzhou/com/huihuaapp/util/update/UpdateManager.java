...
import online.huihua.suzhou.com.huihuaapp.util.AppUtils;
import online.huihua.suzhou.com.huihuaapp.util.StringUtil;
import online.huihua.suzhou.com.huihuaapp.util.http.AsyncHttpPost;
		...
		public void run() {
			try {
				...
				if (storageState.equals(Environment.MEDIA_MOUNTED)) {
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + HuihuaConfig.WY_UPDATE_APK_PATH;
